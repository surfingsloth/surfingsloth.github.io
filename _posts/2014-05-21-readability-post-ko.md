...
---
### 스타워즈 웨딩
스타워즈를 좋아하는 우리 부부의 결혼식은 스타워즈 테마로 진행했다. 결혼식에 다스베이더가 출연해야 했기에, 다스베이더가 죽지 않는 시나리오를 위해 <스타워즈 에피소드 6: 제다이의 귀환>의 리부트 개념으로 <스타워즈 에피소드 6': 우주의 통합(Unity of the Galaxy) 시놉시스를 구성하여 이를 토대로 스타워즈 에피소드 6'를 관람하는 테마의 결혼식을 기획, 제작했다. <br/>
...
아이맥스 카운트다운 이후에는 새롭게 쓴 <스타워즈 에피소드 6': 우주의 통합(Unity of the Galaxy)>의 Opening Crawl을 내보냈다. 물론 자막도 있었다.
